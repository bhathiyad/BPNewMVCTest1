    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<IdentityUser, IdentityRole>()
                ...
                .AddUserStore<BoardPACUserStore>()
                .AddRoleStore<BoardPACRoleStore>();
                //.AddSignInManager<SignInManager<IdentityUser>>(); //.AddSignInManager<BoardPACSignInManager<IdentityUser>>();
